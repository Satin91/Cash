...
class IconsModel {
    ...
    let hygieneIcons  = ["shampoo.c","toothbrush.c","toilet.c","facemask.fill"]
    let entertaimentIcons = ["theatermasks.fill","film.fill","alcohol.c"]
    let workIcons  = ["office.c","working.c","workTime.c"]
    let restIcons = ["bed.double.fill","leaf.fill","wood.c"]
    let sportIcons = ["speedometer","running.c","sport.bike.c","weight.c"]
    ...
    let beautyIcons = ["scissors","hand.mirror.c","comb.c","parfume.c"]
    ...
    let childrenIcons  = ["babyCarriage.c","baby.bottle.c"]
